...
public class AuthenticationSteps {
    ...
    @When("a client sends a request to \\/auth\\/realms\\/twttr\\/protocol\\/openid-connect\\/token to get a valid token for user {string} with an incorrect password")
    public void a_client_sends_a_request_to_auth_realms_twttr_protocol_openid_connect_token_to_get_a_valid_token_for_user_with_an_incorrect_password(String userName) {
        try {
    ...
    @When("a client sends a request to \\/auth\\/realms\\/twttr\\/protocol\\/openid-connect\\/token to get a valid token for user {string} with an incorrect userName")
    public void a_client_sends_a_request_to_auth_realms_twttr_protocol_openid_connect_token_to_get_a_valid_token_for_user_with_an_incorrect_userName(String userName) {
        try {
    ...
    @When("a client sends a request to \\/auth\\/realms\\/twttr\\/protocol\\/openid-connect\\/token to get a valid token for user {string} without an userName")
    public void a_client_sends_a_request_to_auth_realms_twttr_protocol_openid_connect_token_to_get_a_valid_token_for_user_without_an_userName(String userName) {
        try {
    ...
    @When("a client sends a request to \\/auth\\/realms\\/twttr\\/protocol\\/openid-connect\\/token to get a valid token for user {string} without an password")
    public void a_client_sends_a_request_to_auth_realms_twttr_protocol_openid_connect_token_to_get_a_valid_token_for_user_without_an_password(String userName) {
        try {
