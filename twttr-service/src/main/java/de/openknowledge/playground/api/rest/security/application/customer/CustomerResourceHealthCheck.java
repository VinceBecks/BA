...
import de.openknowledge.playground.api.rest.security.application.JaxRsActivator;
...
/**
 * Health check for the resource {@link CustomerResource}.
 */
@Health
@ApplicationScoped
public class CustomerResourceHealthCheck implements HealthCheck {
  ...
  private String getResourcePath() {
    return CustomerResource.class.getAnnotation(Path.class).value();
  }
}
